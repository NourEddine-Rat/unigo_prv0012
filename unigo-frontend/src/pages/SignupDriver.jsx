...
<div className="mb-8">
<h1 className="text-3xl font-bold text-gray-900 mb-2">Inscription Conducteur</h1>
{error && (
...
<div>
<label className="block text-sm font-medium text-gray-700 mb-2">Marque et modèle du véhicule</label>
<input type="text" name="make_model" value={form.make_model} onChange={handleChange} placeholder="ex: Dacia Logan" required className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-black focus:ring-2 focus:ring-black/20 outline-none transition-all bg-white" />
</div>
<div>
<label className="block text-sm font-medium text-gray-700 mb-2">Numéro d'immatriculation</label>
<input type="text" name="plate_number" value={form.plate_number} onChange={handleChange} placeholder="ex: 12345-A-67" required className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-black focus:ring-2 focus:ring-black/20 outline-none transition-all bg-white" />
</div>
<div>
...
<h3 className="text-2xl font-bold text-gray-900 mb-6">Abonnement Conducteur</h3>
<div className="text-4xl font-bold text-gray-900 mb-2">99 MAD</div>
<p className="text-gray-600 mb-6 text-lg">par mois</p>
<div className="space-y-3">
<div className="flex items-center gap-3">
<div className="w-6 h-6 bg-gray-100 rounded-full flex items-center justify-center">
<Check className="w-4 h-4 text-gray-600" />
</div>
<span className="text-gray-900 font-medium">Trajets illimités</span>
</div>
<div className="flex items-center gap-3">
<div className="w-6 h-6 bg-gray-100 rounded-full flex items-center justify-center">
<Check className="w-4 h-4 text-gray-600" />
</div>
<span className="text-gray-900 font-medium">Gestion avancée</span>
</div>
<div className="flex items-center gap-3">
<div className="w-6 h-6 bg-gray-100 rounded-full flex items-center justify-center">
<Check className="w-4 h-4 text-gray-600" />
</div>
<span className="text-gray-900 font-medium">Statistiques détaillées</span>
</div>
<div className="flex items-center gap-3">
<div className="w-6 h-6 bg-gray-100 rounded-full flex items-center justify-center">
<Check className="w-4 h-4 text-gray-600" />
...
<span className="text-gray-900 font-mono">DRV-{Date.now()}</span>
</div>
</div>
</div>
</motion.div>
...
{ name: 'permit_recto', label: 'Permis de conduire Recto', required: true },
{ name: 'permit_verso', label: 'Permis de conduire Verso', required: true },
{ name: 'registration_doc', label: 'Carte grise', required: true },
{ name: 'insurance_doc', label: 'Assurance véhicule', required: true },
...
<EmailVerificationModal 
  ...
  onSuccess={() => navigate('/dashboard/driver')}
